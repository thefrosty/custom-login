...
?>
<div class="wrap">
    <h2><?php esc_html_e('Available Custom Login Extensions', 'custom-login'); ?></h2>
    <form method="post">
        <div class="section">
                    ...
                    <div class="addon-container">
                        <div class="img-wrap">
                            <a href="<?php echo esc_url(
                                ...
                                <img class="thumbnail" src="<?php echo esc_url($extension['image']); ?>" alt="">
                            </a>
                        ...
                        <div class="status" data-status="not-installed" style="display:none">
                            <p><?php esc_html_e('Not Installed', 'custom-login'); ?></p>
                        </div>
                        <hr>
                        <a class="button primary show-if-not-purchased"
                           ...
                           data-toggle="purchase-links-<?php echo esc_attr($key); ?>"
                           style="display:none"><?php esc_html_e('Get this Extension', 'custom-login'); ?></a>
                        <div id="purchase-links-<?php echo esc_attr($key); ?>" style="display:none">
                            <ul>
                                <?php foreach ($extension['links'] as $link) { ?>
                                    <li>
                                        <?php echo wp_kses_post($link['description']); ?>
                                        ...
                                        ); ?>"><?php esc_html_e('PayPal', 'custom-login'); ?></a>
                                        |
                                        <a href="<?php echo esc_url(
                                            add_query_arg([
                                                'edd_action' => 'add_to_cart',
                                        ...
                                        ); ?>"><?php esc_html_e('Credit Card', 'custom-login'); ?></a>
                                    </li>
                                <?php } // Links ?>
                            </ul>
