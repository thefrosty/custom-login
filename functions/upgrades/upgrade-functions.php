...
function ap_custom_login_v2_0_0_upgrades() {
	...
	$new_settings['html_background_color'] = $old_settings['html_background_color'];
    ...
    $new_settings['html_background_position'] = '';
    ...
    $new_settings['logo_background_position'] = '';
    $new_settings['logo_background_repeat'] = '';
    $new_settings['logo_background_size'] = '';
    $new_settings['login_form_background_color'] = $old_settings['login_form_background_color'];
    ...
    $new_settings['login_form_border_color'] = $old_settings['login_form_border_color'];
    ...
    $new_settings['login_form_box_shadow_color'] = $old_settings['login_form_box_shadow_4'];
    $new_settings['login_form_box_shadow_color_checkbox'] = 'off';
    $new_settings['login_form_box_shadow_color_opacity'] = '';
    $new_settings['label_color'] = $old_settings['label_color'];
    ...
    $new_settings['custom_html'] = $old_settings['custom_html'];
    $new_settings['custom_jquery'] = $old_settings['custom_jquery'];
