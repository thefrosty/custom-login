...
Custom Login 2.0 was 140% faster than version 1.0, and version 3.0 is now even better! *Minimum WordPress version is 3.9*

For more information visit the official [Custom Login](http://frosty.media/plugins/custom-login/) page.

> <strong>Support</strong><br>
> [Austin](http://austin.passy.co) and the [Frosty Media](http://frosty.media/) team will always try our best to support the Custom Login plugin on the WordPress.org forums. But we can no garuntee quick responses. If you have an issue we would appriciate you purchasing premium support or making a donation.
>
> Any extensions purchased on [Frosty Media](http://frosty.media/) will not be supported on the WordPress.org forums. You can always browse our *small* but growing [documentation](http://frosty.media/docs). When visiting our support page please have a valid license key for support. We thank you in advance. 

> <strong>Bug Reports</strong><br>
> Bug reports for WordPress SEO are [welcomed on GitHub](https://github.com/thefrosty/custom-login). 
...
Loading a speed improvement.
Better settings page.
More extensions.
For 2.x.x changelog see [2.4 readme](http://plugins.svn.wordpress.org/custom-login/tags/2.4/readme.txt).
