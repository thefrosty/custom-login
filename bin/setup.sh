...
then
	...
	docker-compose exec phpfpm su -s /bin/bash www-data -c "wp theme delete twentyten twentyeleven twentytwelve twentythirteen twentyfourteen twentyfifteen twentysixteen"
